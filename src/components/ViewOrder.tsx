...
const ViewOrder: React.FC<ViewOrderProps> = ({ item, onClose }) => {
  ...
  return (
    <motion.div
      ...
      exit={{ x: "100vw", opacity: 0 }}
      className="z-50 right-0 w-full min-h-screen sm:w-[55%] md:w-[45%] lg:w-[37%] rounded-t-2xl sm:rounded-tr-none sm:rounded-l-2xl bg-[#f1e6e6]"
    >
      {/* header */}
      ...
      <div className="hidden md:flex justify-betwee">
        <div className="flex">

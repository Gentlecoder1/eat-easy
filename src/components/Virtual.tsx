  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className={`transition-all duration-300 ${!toggle ?  'md:ml-[12%] lg:ml-[9%]' : 'md:ml-[20%]'}`}>
        <div className='max-w-[1280px] mx-auto flex flex-col items-center p-6 space-y-10 mb-10'>
            ...
            <div className='flex flex-col items-center text-center'>
              <h1 className='text-[22px] lg:text-[32px] font-bold'>Hello <br /> I'm your virtual assistant.</h1>
